...
{	
	...
	const DWORD FVFPARTICLE = D3DFVF_XYZ | D3DFVF_NORMAL | D3DFVF_TEX2;

// 	const D3DVERTEXELEMENT9 ParticleElements[] = 
// 	{
...
//		float pathS_, pathE_;
	...
	struct OParticle
	{
		D3DXVECTOR3 initialPos_;			// Position
		D3DXVECTOR3 initialVel_;			// Normal


		float initialSize_, initialTime_;	// Tex0
		float lifeTime_, bAlive_;			// Tex1
